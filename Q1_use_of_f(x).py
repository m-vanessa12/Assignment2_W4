# this is for getting user's name
...
# this function is going to help me pass my questions through it.
@staticmethod
def hangman():
    global correct, incorrect
    # these variables are that are holding my answers
    answer1 = '2015'
    ...
    q1 = input(
        "1.When was ALU founded? please enter a number: ").lower()  # the lower fuction is accepting user input and covert it lower case
    if q1 != answer1:  # checkes if the answer is not true to what we have
